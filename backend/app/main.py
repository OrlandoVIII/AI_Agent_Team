...
async def health_check():
    """Health check endpoint with database connectivity check using engine connection."""
    try:
        # Check database connectivity with faster health check timeout using direct engine connection
